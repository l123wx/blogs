...
![img](https://ask.qcloudimg.com/http-save/7256485/51caburde9.png?imageView2/2/w/1620)

那图就是这么画的：

![img](https://ask.qcloudimg.com/http-save/7256485/9ssxpylmd8.png?imageView2/2/w/1620)

如果代码要这么写：

![img](https://ask.qcloudimg.com/http-save/7256485/ba6dw71c00.png?imageView2/2/w/1620)

那么图就是这么画的：

![img](https://ask.qcloudimg.com/http-save/7256485/9q1fgmmi6e.png?imageView2/2/w/1620)

整个这个画图的过程，是对程序的一个拆解，这个拆解的过程实际上也是伴随着设计的。这个图的主要目的就是画出一个一个只有数据依赖、没有过程依赖的小型的上下文。

什么叫过程依赖？如下图所示：

![img](https://ask.qcloudimg.com/http-save/7256485/8s1vnjd253.png?imageView2/2/w/1620)
...
从图落到实现还是有些变化，我们的图实际上有点像 Inception 当中的用户故事地图。用户故事地图是站在用户使用软件的角度列出软件有什么功能。但是软件毕竟还是需要一步一步做出来。所以上面的故事卡，还要重新搬到[看板](https://cloud.tencent.com/product/bi?from=10680)上去，变成看板上的任务卡，按照实现的角度排列顺序调整优先级，并且补充相应的技术卡等卡片。
...
![img](https://ask.qcloudimg.com/http-save/7256485/h6z6oqjxa3.png?imageView2/2/w/1620)
...
![img](https://ask.qcloudimg.com/http-save/7256485/8jghtk4jkt.png?imageView2/2/w/1620)
...
![img](https://ask.qcloudimg.com/http-save/7256485/jo4w6jmnki.png?imageView2/2/w/1620)
...
![img](https://ask.qcloudimg.com/http-save/7256485/25syy9kr8w.png?imageView2/2/w/1620)

然后抽取函数，把要重构的代码块先通过函数封起来，划定重构的边界，把输入输出浮现出来。

![img](https://ask.qcloudimg.com/http-save/7256485/nj4jof2k02.png?imageView2/2/w/1620)

接着写一个新函数。

![img](https://ask.qcloudimg.com/http-save/7256485/ite60ckxmr.png?imageView2/2/w/1620)

然后把函数调用点换掉。

![img](https://ask.qcloudimg.com/http-save/7256485/qnk3u70v5x.png?imageView2/2/w/1620)

然后把旧的函数删掉，打扫现场，该改名改名，该去注释去注释。

![img](https://ask.qcloudimg.com/http-save/7256485/0961395g2l.png?imageView2/2/w/1620)
...
![img](https://ask.qcloudimg.com/http-save/7256485/l5jf781kli.png?imageView2/2/w/1620)
...
![img](https://ask.qcloudimg.com/http-save/7256485/brjgd6nctq.png?imageView2/2/w/1620)

![img](https://ask.qcloudimg.com/http-save/7256485/pv6v3icg1o.png?imageView2/2/w/1620)
...
![img](https://ask.qcloudimg.com/http-save/7256485/574zq29dje.png?imageView2/2/w/1620)

执行了之后就能看到这个：

![img](https://ask.qcloudimg.com/http-save/7256485/ftb99tmxif.png?imageView2/2/w/1620)
...
![img](https://ask.qcloudimg.com/http-save/7256485/pdb8ld7bcy.png?imageView2/2/w/1620)

对应的，我们的名字的结构搬到我们的代码上，三段式表达，given 部分还是输入，when 部分就是被测函数，然后 then 部分写各种 assertion 来校验。

![img](https://ask.qcloudimg.com/http-save/7256485/h103ay4ysz.png?imageView2/2/w/1620)
...
![img](https://ask.qcloudimg.com/http-save/7256485/bnnfsfvt13.png?imageView2/2/w/1620)
...
![img](https://ask.qcloudimg.com/http-save/7256485/tucc69ah2c.png?imageView2/2/w/1620)
...
![img](https://ask.qcloudimg.com/http-save/7256485/31y1svzjml.png?imageView2/2/w/1620)
